...
JoinGameDTO::JoinGameDTO(int32_t playerId, int32_t gameId, uint8_t currentPlayers):
        CommandDTO(playerId, Command::JOIN_GAME),
        playerId(playerId),
        gameId(gameId),
        currentPlayers(currentPlayers) {}

JoinGameDTO::JoinGameDTO(int32_t& gameId, CharacterType characterType):
        CommandDTO(Command::JOIN_GAME), gameId(gameId), characterType(characterType) {}
