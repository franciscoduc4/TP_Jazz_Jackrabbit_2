...
void Enemy::draw_enemy(SDL2pp::Window& window, SDL2pp::Renderer& renderer, SDL2pp::Texture& enemy,
    ...
    renderer.Copy(enemy, SDL2pp::Rect(enemy_pixel_x, enemy_pixel_y, enemy_pixel_w, enemy_pixel_h),
                  SDL2pp::Rect(this->pos_x, this->pos_y, this->draw_width, this->draw_height), 0.0,
    ...
    if (this->pos_x + this->speed > window.GetWidth() - this->draw_width ||
        this->pos_x + this->speed < 0) {  // WIDTH DE PANTALLA HARDCODEADO
        this->speed *= -1;
