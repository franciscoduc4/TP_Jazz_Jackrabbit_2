...
bool Projectile::draw_projectile(SDL2pp::Renderer& renderer, SDL2pp::Texture& projectile) {
    ...
    renderer.Copy(projectile, SDL2pp::Rect(proj_pixel_x, proj_pixel_y, proj_pixel_w, proj_pixel_h),
                  SDL2pp::Rect(this->x, this->y, 20, 10), angle, SDL2pp::NullOpt, this->flip);
